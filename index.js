    ...
    async function registerUser(email, domain, otpPayload, referralPayload, i) {
        try {
            ...
            do {
                ...
                console.log(`[ ${moment().format("HH:mm:ss")} ] ` + `Tunggu Kode Verifikasi...`);
            ...
            console.log(`[ ${moment().format("HH:mm:ss")} ] ` + `Verifikasi Sukses`);
            ...
            console.log(`[ ${moment().format("HH:mm:ss")} ] ` + `Reff Sukses Ke- ${i}\n`);
        } catch (error) {
